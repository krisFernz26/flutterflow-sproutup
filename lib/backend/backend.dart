...
Stream<List<StartupsRecord>> queryStartupsRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(StartupsRecord.collection, StartupsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<MessagesRecord>> queryMessagesRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(MessagesRecord.collection, MessagesRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
...
Stream<List<RoomsRecord>> queryRoomsRecord(
        ...
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(RoomsRecord.collection, RoomsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
