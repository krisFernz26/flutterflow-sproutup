...
class SendPartnershipRequestPageWidget extends StatefulWidget {
  ...
  @override
  _SendPartnershipRequestPageWidgetState createState() =>
      _SendPartnershipRequestPageWidgetState();
}

class _SendPartnershipRequestPageWidgetState
    extends State<SendPartnershipRequestPageWidget> {
              ...
              Padding(
                ...
                child: TextFormField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText:
                        'State your reasons for wanting to partner with this startup.',
              ...
              FFButtonWidget(
                onPressed: () async {
                  ...
                  final roomsRecordData = {
                    ...
                    'users':
                        FieldValue.arrayUnion([widget.startup.userRegisterer]),
                    'startups':
                        FieldValue.arrayUnion([widget.startup.reference]),
                  };

                  await RoomsRecord.collection.doc().set(roomsRecordData);
